    ...
    return (
        <div>
            <div className='d-flex align-items-center mb-sm-0 mb-1 me-1'>
             ...
             <Edit id='edit-tip' color='primary' /> 
             </Button>
             <UncontrolledTooltip target='edit-tip' color='warning' placement='right'>
                 Edit this Drugs Data.
              </UncontrolledTooltip>
             <Modal isOpen={formModal} toggle={() => setFormModal(!formModal)} className='modal-dialog-centered'>
               <ModalHeader color='success' toggle={() => setFormModal(!formModal)}>Drug edit Page</ModalHeader>
               <ModalBody>
                 <div className='mb-2'>
